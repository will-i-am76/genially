...
<head>
  ...
  <title>Assemblage embrayage</title>
  <style>
    body {
      color: #ffffff;
...
<body>
  ...
  <script>
    ...
    try {
      ...
      try {
        scaffolding.addCloudProvider(new Scaffolding.Cloud.WebSocketProvider(["wss://clouddata.turbowarp.org","wss://clouddata.turbowarp.xyz"], "p4-@Projet Scratch.sb3"));
      } catch (error) {
        console.error(error);
      }
